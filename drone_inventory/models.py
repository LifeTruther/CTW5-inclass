...
# import from marshmallow to get marshaller
...
class DroneSchema(ma.Schema):
    class Meta:
        ...
        fields = ['id', 'name', 'description', 'price', 'camera_quality', 'flight_time', 'max_speed','dimensions','weight','cost_of_prod','series','user_token']
